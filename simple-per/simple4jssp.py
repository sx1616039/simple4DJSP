...
class JobEnv:
    def __init__(self, case_name, path, max_job=50, max_machine=20, no_op=False, gen_data=False):
        ...
        self.state_num = self.max_job * 2 + self.max_machine * 2
    ...
    def _get_state(self):
        ...
        self.state[self.max_machine * 2 + self.max_job: self.max_machine * 2 + self.max_job + self.job_num] = self.assignable_job
